...
const NOVEDADES = [
	...
	contenido: `Diseña el fondo de pantalla de laptops y tablets Ceibal 2027.
        ...
        imagen: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDLCM2UHZV9oX4fonaObpBg4-bTEV3XBR1CxHZjq9VPl5QrlQliYmgLufX&s=10",
    ...
    },
	{
        ...
        imagen: "https://lh3.googleusercontent.com/d/190XAQmb0nQGk30R6wdIupNp403YPvdnL",
        enlace: "",
		lsu: ""
    },
    {
...
function cargarCarteleraNovedades() {
    ...
    NOVEDADES.forEach(novedad => {
		...
		if (novedad.lsu) {
			estructuraHtml += `
				<button type="button" class="btn-lsu" onclick="abrirModalLSU('${novedad.lsu}')">
					<img src="images/lsu.png" alt="Lengua de Señas Uruguaya (LSU)">
					<span>LSU</span>
				</button>
			`;
		}
